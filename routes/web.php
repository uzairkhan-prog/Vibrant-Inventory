...
use App\Http\Controllers\AgentLedgerController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // Silently refreshes the CSRF token for long-lived pages doing AJAX requests,
    // so a stale token (e.g. after session regeneration) doesn't surface as a 419.
    ...
    Route::get('agents/{agent}/ledger', [AgentLedgerController::class, 'show'])->name('agents.ledger');
