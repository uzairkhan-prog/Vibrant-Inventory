            ...
            <table class="table table-striped table-hover table-bordered align-middle text-center" id="suppliersTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $supplier->date ? \Carbon\Carbon::parse($supplier->date)->format('d-m-Y') : '-' }}</td>
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('suppliers.edit', $supplier) }}" class="btn btn-sm btn-success me-1 text-white" title="Edit">
