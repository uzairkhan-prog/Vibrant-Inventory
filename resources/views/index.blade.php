        ...
        <div class="col-lg-4">
          <div class="card overflow-hidden">
            <div class="card-body pb-0">
              ...
              <!-- More stat rows same as your original content -->
              <!-- You can paste all your original inner divs here for stats, products, comments -->

            </div>
          </div>
        </div>

        <!-- Full row for Products Performance -->
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <div class="d-md-flex align-items-center">
